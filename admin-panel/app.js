...
document.getElementById('loginForm').addEventListener('submit', async (e) => {
  ...
  const res = await fetch('https://my-backend-hsra.onrender.com/api/login', {
    method: 'POST',
...
document.getElementById('logoutBtn').addEventListener('click', async () => {
  try {
    const res = await fetch('https://my-backend-hsra.onrender.com/api/admin/logout', {
      method: 'POST',
...
document.getElementById('serviceForm').addEventListener('submit', async (e) => {
  ...
  const url = serviceEditMode
    ? `https://my-backend-hsra.onrender.com/api/admin/services/${editingServiceId}`
    : `https://my-backend-hsra.onrender.com/api/admin/services`;
...
async function loadServices() {
  const res = await fetch('https://my-backend-hsra.onrender.com/api/admin/services', {
    headers: { Authorization: `Bearer ${token}` }
  });
  const data = await res.json();
...
async function deleteService(id) {
  ...
  const res = await fetch(`https://my-backend-hsra.onrender.com/api/admin/services/${id}`, {
    method: 'DELETE',
    headers: { Authorization: `Bearer ${token}` }
  });
  const data = await res.json();
...
document.getElementById('offerForm').addEventListener('submit', async (e) => {
  ...
  const url = offerEditMode
    ? `https://my-backend-hsra.onrender.com/api/admin/offers/${editingOfferId}`
    : `https://my-backend-hsra.onrender.com/api/admin/offers`;
...
async function loadOffers() {
  const res = await fetch('https://my-backend-hsra.onrender.com/api/admin/offers', {
    headers: { Authorization: `Bearer ${token}` }
  });
...
async function editOffer(id) {
  const res = await fetch(`https://my-backend-hsra.onrender.com/api/admin/offers/${id}`, {
    headers: { Authorization: `Bearer ${token}` }
  });
